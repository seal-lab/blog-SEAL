...
{:refdef: style="text-align: center;"}
**L'aventure vous a plu ?**<br/>**L'équipe SEAL de l'EPITA recrute des étudiants dès la première année d'école d'ingénieur.**<br/> **Alors, pourquoi pas vous dans quelques années ?**
{: refdef}
